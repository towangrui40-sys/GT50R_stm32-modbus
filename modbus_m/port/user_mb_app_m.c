...
//SM_RTU_MemDef m_usRegHoldingBuf[SM_ADDR_HREG_TOTAL];
        ...
        USHORT usNRegs, eMBRegisterMode eMode)
{
    ...
    USHORT          m_REG_HOLDING_START;
    USHORT          m_REG_HOLDING_NREGS;
    USHORT          usRegHoldStart;
	//UCHAR 			slaveaddr;
	pusRegHoldingBuf =  usMRegHoldBuf[ucMBMasterGetDestAddress() - 1];
	//-----------------user code--------------------//
	//slaveaddr = ucMBMasterGetDestAddress();


	m_REG_HOLDING_START = M_REG_HOLDING_START;
	m_REG_HOLDING_NREGS = M_REG_HOLDING_NREGS;
